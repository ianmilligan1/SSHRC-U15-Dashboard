...
export default function AboutPage() {
  ...
  return (
    <div className="about-page">
      ...
      <p>
        The project went through <strong>three sessions</strong> of development, each demonstrating
        a different aspect of the human-AI collaboration:
      </p>
      <ul style={{ marginBottom: '1rem', lineHeight: 1.8 }}>
        <li>
          <strong>Session 1 (March 8 evening):</strong> The initial detailed prompt (326 lines)
          produced a working data pipeline and single-page dashboard with 7 competition types
          in approximately 2 hours. This is the "heavy lift" — scraping, parsing, and
          visualizing decades of inconsistently-formatted data.
        </li>
        <li>
          <strong>Session 2 (March 8-9):</strong> Short human instructions expanded and refined
        ...
        <li>
          <strong>Session 3 (March 9):</strong> The human spotted a 6-year gap in Insight Grants
      ...
      <p>
        Initial build completed on <strong>March 8, 2026</strong>. Final refinements
        completed <strong>March 9, 2026</strong>.
      </p>
      ...
      <details className="prompt-viewer">
        ...
        <div className="prompt-content" style={{ fontFamily: 'var(--font-body)', fontSize: '0.85rem' }}>
          ...
          <p style={{ color: 'var(--text-secondary)', fontStyle: 'italic', marginBottom: '0.25rem' }}>Session 2 — Expanding and restructuring:</p>
          ...
          <p style={{ color: 'var(--text-secondary)', fontStyle: 'italic', marginBottom: '0.25rem', marginTop: '1rem' }}>Session 3 — Data quality and analysis:</p>
